using System;
using System.Text;
using Binus.API.Infrastructures;
using Binus.Core.Application;
using Binus.Core.Application.Command;
using Binus.Core.Application.Services;
using Binus.Core.Constant.Constant;
using Binus.Core.Infrastructure;
...
namespace Binus.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.API v1"));
            }
