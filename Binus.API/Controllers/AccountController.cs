...
using Binus.Core.Application.Command.Common.Account.Commands.CreateAccount;
using Binus.Core.Application.Command.Common.Account.Commands.RemoveAccount;
using Binus.Core.Application.Command.Common.Account.Queries.AccountLogin;
using Binus.Core.Application.Commons;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace Binus.API.Controllers
{
