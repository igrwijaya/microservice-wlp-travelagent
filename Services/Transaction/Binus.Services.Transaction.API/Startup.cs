using System;
using System.Text;
using Binus.Services.Transaction.API.Infrastructures;
using Binus.Transaction.Core.Application;
using Binus.Transaction.Core.Application.Command;
using Binus.Transaction.Core.Application.Services;
using Binus.Transaction.Core.Constant.Constant;
using Binus.Transaction.Core.Infrastructure;
...
namespace Binus.Services.Transaction.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.Transaction.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.Transaction.API v1"));
            }
