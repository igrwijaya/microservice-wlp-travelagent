using System;
using System.Text;
using Binus.Booking.Core.Application;
using Binus.Booking.Core.Application.Command;
using Binus.Booking.Core.Application.Services;
using Binus.Booking.Core.Constant.Constant;
using Binus.Booking.Core.Infrastructure;
...
namespace Binus.Services.Transaction.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.Booking.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.Booking.API v1"));
            }
