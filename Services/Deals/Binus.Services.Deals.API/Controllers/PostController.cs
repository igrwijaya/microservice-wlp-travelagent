...
using Binus.Deals.Core.Application.Command.Post.Commands.AddPostCommentByUser;
using Binus.Deals.Core.Application.Command.Post.Commands.CreatePostByUser;
using Binus.Deals.Core.Application.Command.Post.Queries.GetPostWithLatestComment;
