using System;
using System.Text;
using Binus.Deals.Core.Application;
using Binus.Deals.Core.Application.Command;
using Binus.Deals.Core.Application.Services;
using Binus.Deals.Core.Constant.Constant;
using Binus.Deals.Core.Infrastructure;
using Binus.Services.Deals.API.Infrastructures;
...
namespace Binus.Services.Deals.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.Deals.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.Deals.API v1"));
            }
