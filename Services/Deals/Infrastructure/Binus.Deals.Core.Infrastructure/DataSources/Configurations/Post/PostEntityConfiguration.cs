...
{
    public class PostEntityConfiguration : IEntityTypeConfiguration<Deals.Core.Domain.AggregateRoots.Post.Post>
    {
        public void Configure(EntityTypeBuilder<Deals.Core.Domain.AggregateRoots.Post.Post> builder)
        {
