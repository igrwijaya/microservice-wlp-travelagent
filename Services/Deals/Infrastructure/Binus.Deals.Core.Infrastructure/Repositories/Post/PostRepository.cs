...
namespace Binus.Deals.Core.Infrastructure.Repositories.Post
{
    public class PostRepository : BaseRepository<Deals.Core.Domain.AggregateRoots.Post.Post>, IPostRepository
    {
        #region Constructors
        ...
        {
            return Task.FromResult(Search(delegate(DbSet<Deals.Core.Domain.AggregateRoots.Post.Post> dbSet)
            {
