using System;
using System.Text;
using Binus.DealsTourRadar.Core.Application;
using Binus.DealsTourRadar.Core.Application.Command;
using Binus.DealsTourRadar.Core.Application.Services;
using Binus.DealsTourRadar.Core.Constant.Constant;
using Binus.DealsTourRadar.Core.Infrastructure;
using Binus.Services.DealsTourRadar.API.Infrastructures;
...
namespace Binus.Services.DealsTourRadar.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.DealsTourRadar.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.DealsTourRadar.API v1"));
            }
