...
namespace Binus.DealsTourRadar.Core.Infrastructure.Repositories.Post
{
    public class PostRepository : BaseRepository<DealsTourRadar.Core.Domain.AggregateRoots.Post.Post>, IPostRepository
    {
        #region Constructors
        ...
        {
            return Task.FromResult(Search(delegate(DbSet<DealsTourRadar.Core.Domain.AggregateRoots.Post.Post> dbSet)
            {
