using System;
using System.Text;
using Binus.Partner.Core.Application;
using Binus.Partner.Core.Application.Command;
using Binus.Partner.Core.Application.Services;
using Binus.Partner.Core.Constant.Constant;
using Binus.Partner.Core.Infrastructure;
using Binus.Services.Partner.API.Infrastructures;
...
namespace Binus.Services.Partner.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.Partner.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.Partner.API v1"));
            }
