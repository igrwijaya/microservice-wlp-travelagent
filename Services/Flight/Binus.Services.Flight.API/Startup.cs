using System;
using System.Text;
using Binus.Flight.Core.Application;
using Binus.Flight.Core.Application.Command;
using Binus.Flight.Core.Application.Services;
using Binus.Flight.Core.Constant.Constant;
using Binus.Flight.Core.Infrastructure;
using Binus.Services.Flight.API.Infrastructures;
...
namespace Binus.Services.Flight.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.Flight.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.Flight.API v1"));
            }
