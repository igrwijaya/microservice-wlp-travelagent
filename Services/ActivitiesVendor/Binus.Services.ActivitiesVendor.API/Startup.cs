using System;
using System.Text;
using Binus.ActivitiesVendor.Core.Application;
using Binus.ActivitiesVendor.Core.Application.Command;
using Binus.ActivitiesVendor.Core.Application.Services;
using Binus.ActivitiesVendor.Core.Constant.Constant;
using Binus.ActivitiesVendor.Core.Infrastructure;
using Binus.Services.ActivitiesVendor.API.Infrastructures;
...
namespace Binus.Services.ActivitiesVendor.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.ActivitiesVendor.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.ActivitiesVendor.API v1"));
            }
