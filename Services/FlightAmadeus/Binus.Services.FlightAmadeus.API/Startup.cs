using System;
using System.Text;
using Binus.FlightAmadeus.Core.Application;
using Binus.FlightAmadeus.Core.Application.Command;
using Binus.FlightAmadeus.Core.Application.Services;
using Binus.FlightAmadeus.Core.Constant.Constant;
using Binus.FlightAmadeus.Core.Infrastructure;
using Binus.Services.FlightAmadeus.API.Infrastructures;
...
namespace Binus.Services.FlightAmadeus.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Binus.Services.FlightAmadeus.API", Version = "v1"});
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Binus.Services.FlightAmadeus.API v1"));
            }
